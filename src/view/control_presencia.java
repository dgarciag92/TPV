 ...
 * @author AO
 */
public class control_presencia extends javax.swing.JFrame {

    /**
     * Creates new form control_presencia
     */
    public control_presencia() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(control_presencia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new control_presencia().setVisible(true);
            }
        });
    }
